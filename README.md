...
Модуль `client/player/assets/manifestRegistry.js` содержит описания тестовых анимаций главного героя из проекта [TLA3.0TG](https://github.com/FSH101/TLA3.0TG):
...
- `DirectionOrder` — соответствие индексов направлений и гекс-компаса (по умолчанию `southEast, east, northEast, northWest, west, southWest`);
